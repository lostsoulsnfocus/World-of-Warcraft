...
function XiTimers:GetBorder(side)
	...
	elseif ((side == "LEFT" and timerBarPos == "LEFT" or side == "RIGHT" and timerBarPos == "RIGHT") and ((self.nrOfTimers>1 and TotemTimers.ActiveProfile.ShowCooldowns) or not self.timerOnButton))
...
oocframe:RegisterEvent("PET_BATTLE_OPENING_START")
oocframe:RegisterEvent("PET_BATTLE_CLOSE")
