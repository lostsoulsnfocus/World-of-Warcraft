...
--[[EncounterJournalFrame Changes]]
		...
		if event == "ADDON_LOADED" and arg1 == "Blizzard_EncounterJournal"  then
			...
			Border(EncounterJournalEncounterFrameInstanceFrame,340,264,"Center",3,40,12,"MEDIUM")
        ...
        _G["EncounterJournalEncounterFrameInfoEncounterTitle"]:SetFont(unpack(miirgui.font),14, "OUTLINE")   
			...
			for i = 1,6 do
			_G["EncounterJournalEncounterFrameCreatureButton"..i.."Creature"]:SetTexCoord(0.15, 0.85, 0.15, 0.85)
			i = i+1
			end
...
hooksecurefunc("EncounterJournal_DisplayInstance", function(instanceID, noButton)
	...
	self.instance.title:ClearAllPoints()
	self.instance.title:SetPoint("Center", 0, 180)
	self.instance.title:SetTextColor(unpack(miirgui.Color))
